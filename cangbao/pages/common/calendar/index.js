  ...
  function(e, t, a) {
    ...
    class d extends o.default {
      ...
      calculateDays(e, t, a) {
        ...
        var that=this
        wx.request({
          url: app.api.auc_calendarcount + time,
          data: {},
          header: Header.logintype(),
          method: 'get',
          success(res) {
            if (res.statusCode == 204) {
              ...
              for (let a = 1; a <= h; a++)
                n.push({
                  year: e,
                  month: t,
                  num: res.data.data[a-1].count,
                  day: a,
                  choosed: !1,
                  week: l.dayOfWeek(e, t, a)
                });
              const y = that.initSelectedDayWhenRender(e, t, a),
              ...
              n.forEach(e => {
                ...
                const a = l.newDate(e.year, e.month, e.day).getTime(),
                  { disablePastDay: n } = that.getCalendarConfig();
                ...
                that.setData({ 'calendar.days': n, 'calendar.selectedDay': y || [] });
            }
